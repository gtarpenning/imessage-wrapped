...
export const metadata = {
  ...
  description:
    "Your year in messages, visualized. Download the macOS app or use the CLI to analyze your iMessage history.",
  ...
  twitter: {
    ...
    title: "iMessage Wrapped",
    description:
      "Your year in messages, visualized. Download the macOS app or use the CLI.",
    images: ["/og-image.png"],
  },
  icons: {
    icon: {
